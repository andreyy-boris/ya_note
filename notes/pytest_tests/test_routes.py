...
# Доступность страницы со списком заметок, страницы добавления новой записи и страницы успешного добавления записей.
@pytest.mark.parametrize(
    'name',
...
# Автору заметки доступны страницы отдельной заметки, её редактирования и удаления.
